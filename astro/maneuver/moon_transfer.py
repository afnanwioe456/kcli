...
#         T = T(a.to_value(u.km), orbit.attractor.mu.to_value(u.km ** 3 / u.s ** 2)) * u.s
#         trans_t = cap_t - T / 2
#         # 检查航天器与窗口的相位差
...
def transfer_target(orbit: Orbit, moon: Body, cap_t, pe_m, inc, relative=True):
    """向卫星转移的瞄准轨道, 位于捕获临界前
